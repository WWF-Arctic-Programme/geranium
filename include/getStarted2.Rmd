...
Geranium is based on the extensive [ArcNet](https://www.arcticwwf.org/our-priorities/nature/arcnet/) database of 705 Conservation Features (CFs), which systematically represent marine biodiversity and their distribution across the Arctic: from benthos to marine mammals
...
Geranium assesses the level of conservation concern associated with individual existing or potential industrial activities for each of the CFs. The assessment was conducted by the taxonomic experts who selected the [ArcNet](https://www.arcticwwf.org/our-priorities/nature/arcnet/) CFs and led data collection and conservation target setting (James et al, 2024).

Geranium uses a simple three-level approach where:
