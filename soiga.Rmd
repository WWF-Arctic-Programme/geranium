...
```{r}
downloadLink("downloadMetrics","Download interim tables for SR and MNSR")
HTML("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;")
...
output$downloadMetrics <- downloadHandler(
   ...
   ,content=function(file) {
     ...
     # str(res)
     # res <- iris
      xlsx::write.xlsx(dNAM,file,sheetName="NAM",append=FALSE)
      xlsx::write.xlsx(dNAO,file,sheetName="NAO",append=TRUE)
